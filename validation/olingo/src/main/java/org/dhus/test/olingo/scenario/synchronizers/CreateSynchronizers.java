...
public class CreateSynchronizers implements TestScenario
{

   private final static Logger LOGGER = LogManager.getLogger(CreateSynchronizers.class.getName());
   ...
   public CreateSynchronizers(ODataOperator odataOperator)
   {
