...
public class UpdateSynchronizers implements TestScenario {

    private final static Logger LOGGER = LogManager
	    .getLogger(UpdateSynchronizers.class.getName());
    ...
    public UpdateSynchronizers(ODataOperator odataOperator) {
