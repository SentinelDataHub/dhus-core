...
public class IngestibleODataProduct implements IngestibleProduct
{
   ...
   private IngestibleODataProduct(String uuid, String origin, Date ingestionDate, Date creationDate,
         ...
         List<MetadataIndex> metadataIndexes, Product physicalProduct, Product quicklook, Product thumbnail, Boolean onDemand, Boolean online, long sourceId)
   {
      this.uuid = uuid;
      this.origin = origin;
   ...
   public static IngestibleODataProduct fromODataEntry(ODataEntry productEntry, String origin, String itemClass,
         List<MetadataIndex> metadataIndexList, Map<String, ? extends Product> productAndDerived, long sourceId)
         throws MissingProductsException
   {
      ...
      if (physicalProduct != null)
      {
         return new IngestibleODataProduct(uuid, origin, ingestionDate, creationDate, itemClass, identifier,
               contentStart, contentEnd, footprint, metadataIndexList, physicalProduct, quicklook, thumbnail, onDemand, online, sourceId);
      }
   ...
   public ProductSource getBestSource()
   {
      ...
      {
         return ((DownloadableProduct)product).getProductSource();
      }
      return null;
   }
