...
public final class Metric
{
   ...
   public Metric(Timestamp date, String name, MetricTypes type,
         Long count,
         String value,
         Double max, Double min, Double mean, Double median, Double standardDeviation, Double _75thPercentile, Double _95thPercentile, Double _98thPercentile, Double _99thPercentile, Double _999thPercentile,
   ...
   */
   ...
   public static class Histogram
   {
      ...
      public Histogram(Double max, Double min, Double mean, Double median, Double standardDeviation,
   ...
   private static class HistogramFromSnapshot extends Histogram
   {
      ...
      public Double getMax()
      {
         return Double.valueOf(adapted.getMax());
      }

      @Override
      public Double getMin()
      {
         return Double.valueOf(adapted.getMin());
      }
