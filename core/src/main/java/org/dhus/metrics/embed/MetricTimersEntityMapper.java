 ...
 */
public abstract class MetricTimersEntityMapper implements RowMapper<Entity>
   {
      @Override
      public Entity map(ResultSet rs, StatementContext ctx) throws SQLException
      {
         ...
         entity.addProperty(new Property(null, MetricModel.MINIMUM, ValueType.PRIMITIVE, rs.getDouble("min")));
         entity.addProperty(new Property(null, MetricModel.MAXIMUM, ValueType.PRIMITIVE, rs.getDouble("max")));
