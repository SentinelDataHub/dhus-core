...
public class CollectionService extends WebService
{
    ...
    */
   @Transactional(readOnly = true)
   public Iterator<Product> getCollectionProducts(ProductSQLVisitor visitor, String collectionName)
         throws ODataApplicationException
   {
      StringBuilder sb = new StringBuilder();
      //sb.append("select products from ProductCart as cart inner join cart.products as products ");
      sb.append("select products from Collection as c inner join c.products as products ");
      ...
      sb.append("c.name='").append(collectionName).append('\'');
