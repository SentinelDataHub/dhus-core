...
public class DataStoreManagerIT extends AbstractTestNGSpringContextTests
{
   ...
   public void getDataStoresTest()
   {
      ...
      Assert.assertEquals(((HfsDataStoreConf) dataStores.get(0)).getMaxFileNo(), Integer.valueOf(5));
