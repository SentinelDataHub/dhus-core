...
public class HfsDataStoreIT extends AbstractTransactionalTestNGSpringContextTests
{
   ...
   void init() throws IOException
   {
      ...
      hfsDataStore = new HfsDataStore("hfs-test", hfs, DataStoreRestriction.NONE, 0, -1L, 0, false, null);
