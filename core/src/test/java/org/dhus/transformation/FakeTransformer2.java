...
public class FakeTransformer2 implements Transformer
{
   static final String NAME = "TransformationTwo";
   static final String DESCRIPTION = "DescriptionTwo";
   ...
   {
      return Collections.singletonList(new TransformationParameter(PARAM_FOO_NAME, PARAM_FOO_DESCRIPTION));
   }
