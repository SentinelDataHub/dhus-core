...
import fr.gael.dhus.database.object.config.synchronizer.*;
...
public class SynchronizerManagerTest extends AbstractTestNGSpringContextTests
{
   ...
   public void getSynchronizersTest()
   {
      ...
      Assert.assertEquals(((EventSynchronizer) scanners.get(0)).getSkip(), new Integer(10));
      ...
      Assert.assertEquals(((UserSynchronizer) scanners.get(2)).getSkip(), new Integer(0));
   ...
   public void updateTest()
   {
      ...
      Assert.assertEquals(((EventSynchronizer) sync2).getSkip(), new Integer(20));
   ...
   {
      ProductSynchronizer ps = syncService.getSynchronizerConfById(3L, ProductSynchronizer.class);
      Assert.assertNotNull(ps);
      ProductSynchronizer ps2 = syncService.getSynchronizerConfById(2L, ProductSynchronizer.class);
      Assert.assertNull(ps2);
      Iterator<EventSynchronizer> syncs = syncService.getSynchronizerConfs(EventSynchronizer.class);
      Assert.assertNotNull(syncs.next());
      Assert.assertNotNull(syncs.next());
      syncs.next();
   }
