...
public class ConfigurationManagerIT extends AbstractTestNGSpringContextTests
{
   @Autowired
   ...
   public void testGetTransformationConfiguration()
   {
      TransformationConfiguration conf = configurationManager.getTransformationConfiguration();
      Assert.assertNotNull(conf);
      Assert.assertEquals(conf.getIngestCorePoolSize(), 4);
      Assert.assertEquals(conf.getInterval(), 600_000);
   }
}
