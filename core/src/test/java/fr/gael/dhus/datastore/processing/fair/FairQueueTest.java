...
public class FairQueueTest
{
   ...
   private class FairQueueTestString extends AbstractFairQueueEntry
   {
   ...
   {
      Assert.assertEquals(queue.size(), 0);
      Assert.assertTrue(queue.offer(new FairQueueTestString("key1", "item1")));
      Assert.assertEquals(queue.size(), 1);
      Assert.assertTrue(queue.offer(new FairQueueTestString("key2", "item2")));
      Assert.assertEquals(queue.size(), 2);
   }
   ...
   {
      ArrayList<FairQueueTestString> list = new ArrayList<>();
      queue.offer(new FairQueueTestString("key1", "item1"));
      queue.offer(new FairQueueTestString("key1", "item2"));
      queue.offer(new FairQueueTestString("key1", "item3"));
      queue.offer(new FairQueueTestString("key2", "item4"));
   ...
   public void testContains()
   {
      ...
      queue.offer(new FairQueueTestString("key2", "item5"));
      Assert.assertEquals(queue.size(), 5);
      Assert.assertEquals(queue.contains(new FairQueueTestString("key1", "item2")), true);
   }
   ...
   public void testRemove()
   {
      ...
      queue.offer(new FairQueueTestString("key2", "item5"));
      Assert.assertEquals(queue.size(), 5);
      Assert.assertEquals(queue.remove(), new FairQueueTestString("key1", "item1"));
      Assert.assertEquals(queue.size(), 4);
      Assert.assertEquals(queue.remove(), new FairQueueTestString("key2", "item4"));
      Assert.assertEquals(queue.size(), 3);
      Assert.assertEquals(queue.remove(), new FairQueueTestString("key1", "item2"));
      Assert.assertEquals(queue.size(), 2);
      Assert.assertEquals(queue.remove(), new FairQueueTestString("key2", "item5"));
      Assert.assertEquals(queue.size(), 1);
      Assert.assertEquals(queue.remove(), new FairQueueTestString("key1", "item3"));
      Assert.assertEquals(queue.size(), 0);
   }
   ...
   public void testElement()
   {
      ...
      queue.offer(new FairQueueTestString("key2", "item5"));
      Assert.assertEquals(queue.size(), 5);
      Assert.assertEquals(queue.element(), new FairQueueTestString("key1", "item1"));
      Assert.assertEquals(queue.size(), 5);
      Assert.assertEquals(queue.element(), new FairQueueTestString("key1", "item1"));
      Assert.assertEquals(queue.size(), 5);
   }
   ...
   public void testRemoveAll()
   {
      ...
      Assert.assertEquals(queue.size(), 1);
      ArrayList<FairQueueTestString> list2 = new ArrayList<>();
   ...
   public void testRemove3()
   {
      ...
      queue.offer(new FairQueueTestString("key2", "item5"));
      Assert.assertEquals(queue.size(), 5);
      Assert.assertEquals(queue.remove(new FairQueueTestString("key1", "item2")), true);
      Assert.assertEquals(queue.size(), 4);
      Assert.assertEquals(queue.remove(new FairQueueTestString("key1", "item5")), false);
      Assert.assertEquals(queue.size(), 4);
   }
}
