...
public class ProductDaoIT extends AbstractHibernateDaoIT<Product, Long>
{
   ...
   public void create ()
   {
      ...
      String indexType = "text/plain";
      String indexValue = "test";

      MetadataIndex mi = new MetadataIndex(new MetadataDefinition(indexName, indexType, "", ""), indexValue);
                     ...
                     throws HibernateException
               {
                  String sql =
                        "SELECT count(*) FROM " + table +
                              " WHERE PRODUCT_ID = ?1";
                  Query query = session.createNativeQuery (sql).setParameter(1, pid);
