...
public class TestCacheSymDS extends AbstractTransactionalTestNGSpringContextTests
{
   ...
   @Test
   public void testReplicateProducts () throws ExceptionVisitExpression, ODataApplicationException
   {
      String cache_name = "products";
      String uid = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaab0";
      List<Product> products;
      ProductSQLVisitor visitor = new ProductSQLVisitor (null, null);

      Cache cache = cacheManager.getCache (cache_name);

      products = productService.getProducts (visitor, null, -1, -1);
      Assert.assertNotNull (products);
      Assert.assertTrue (products.size () > 0);
      Object key1 = Arrays.asList (visitor.getHqlQuery (), visitor.getHqlParameters(), null, -1, -1);
   ...
   /**
    * Allows to perform test without depend of the truly SearchService class
    */
   private static class SearchServiceForTest extends SearchService
   {
      @Override
