 ...
 * Copyright (C) 2015,2018,2019 GAEL Systems
 *
...
@ContextConfiguration(locations = "classpath:fr/gael/dhus/spring/context-job-test.xml", loader = TestContextLoader.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
public class SchedulerIT extends AbstractTransactionalTestNGSpringContextTests
{
   @Autowired
